...
Este servidor MCP (Model Context Protocol) para Azure DevOps ha sido transformado de una implementación específica para YOUR_ORGANIZATION a un **sistema genérico y configurable** que puede adaptarse a cualquier organización.
...
## 💡 Migración de YOUR_ORGANIZATION a Sistema Genérico

### ✅ Cambios Implementados

1. **Configuración Dinámica**
   - Reemplazado hardcoding específico de YOUR_ORGANIZATION con configuración basada en HashMap
...
2. **Manejo Genérico de Campos**
   - Creado `GenericWorkItemFieldsHandler` que reemplaza `YOUR_ORGANIZATIONWorkItemFieldsHandler`
   - Implementada validación configurable de campos requeridos
   - Mantenida compatibilidad retroactiva con tipos de YOUR_ORGANIZATION
...
- Tipos de work items específicos de YOUR_ORGANIZATION (Historia, Historia Técnica, Tarea)
