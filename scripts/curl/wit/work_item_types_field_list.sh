...
usage() {
  cat <<'USAGE'
Uso: work_item_types_field_list.sh --project <project> --type <tipo> [--api-version <ver>] [--raw] [--help]
...
Ejemplos:
  ...
  scripts/curl/wit/work_item_types_field_list.sh --project Gerencia_Tecnologia --type "User Story"
USAGE
}
