...
usage() {
  cat <<'USAGE'
Uso: comments_delete.sh --project <proj> --work-item-id <id> --comment-id <id> [--help]
...
Ejemplos:
  scripts/curl/wit/comments_delete.sh --project "Mi Proyecto" --work-item-id 123 --comment-id 456
USAGE
}
...
API_VER_OVERRIDE="7.2-preview.4"
