...
usage() {
  cat <<'USAGE'
Uso: comments_reactions_list.sh --project <proj> --work-item-id <id> --comment-id <id> [--help]

Fuente: api_doc/wit_sections/comments_reactions.md

Descripción:
  Lista las reacciones (por tipo) de un comentario.
...
Ejemplos:
  scripts/curl/wit/comments_reactions_list.sh --project "Mi Proyecto" --work-item-id 123 --comment-id 456
USAGE
}
...
URL="${DEVOPS_BASE}/${ENC_PROJECT}/_apis/wit/workItems/${ENC_WI}/comments/${ENC_COMMENT}/reactions?api-version=${API_VER_OVERRIDE}"
