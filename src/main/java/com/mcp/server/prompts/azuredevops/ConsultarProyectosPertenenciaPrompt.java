 ...
 * específico en la organización YOUR_ORGANIZATION, proporcionando un análisis detallado
...
public class ConsultarProyectosPertenenciaPrompt extends BasePrompt {
    ...
    public ConsultarProyectosPertenenciaPrompt() {
        super(
            ...
            "Consulta y analiza a qué proyectos y equipos pertenece un usuario específico en Azure DevOps de YOUR_ORGANIZATION, incluyendo análisis de permisos y estructura organizacional.",
            List.of(
    ...
    public PromptResult execute(Map<String, Object> arguments) {
        ...
        if (usuario != null && !usuario.trim().isEmpty()) {
            userPrompt.append("Quiero consultar a qué proyectos pertenece el usuario: ")
                     .append(usuario).append(" en Azure DevOps de YOUR_ORGANIZATION.\n\n");
        } else {
            userPrompt.append("Quiero consultar a qué proyectos pertenezco en Azure DevOps de YOUR_ORGANIZATION.\n\n");
        }
        ...
        return new PromptResult(
            "Consulta de pertenencia a proyectos en Azure DevOps de YOUR_ORGANIZATION" + 
