 ...
 * la estructura organizacional de Sura.
 */
public class ConsultaProyectosPertenenciaPrompt extends BasePrompt {
    ...
    public ConsultaProyectosPertenenciaPrompt() {
        super(
            ...
            "Genera una consulta para identificar todos los proyectos de Azure DevOps a los que pertenece el usuario, considerando la estructura organizacional de Sura con sus tres proyectos principales: Gerencia_Tecnologia, Gerencia_Tecnologia_Egv_Aseguramiento y Portafolios.",
            List.of(
    ...
    public PromptResult execute(Map<String, Object> arguments) {
        ...
        promptText.append(" en Azure DevOps de Sura.\n\n");
        ...
        return new PromptResult(
            "Consulta estructurada para identificar proyectos de pertenencia del usuario en Azure DevOps de Sura",
            messages
        );
    }
}
