...
/**
 * Manejador genérico de campos de work items que reemplaza la lógica hardcodeada específica de YOUR_ORGANIZATION.
...
public class GenericWorkItemFieldsHandler {
    ...
    /**
     * Convierte valores específicos para tipos de work items de YOUR_ORGANIZATION.
    ...
    public Map<String, Object> processYOUR_ORGANIZATIONCompatibleFields(String workItemType, Map<String, Object> inputFields) {
        ...
        // Agregar lógica específica para tipos de YOUR_ORGANIZATION si es necesario
