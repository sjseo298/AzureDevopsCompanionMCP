...
import com.mcp.server.services.helpers.WitCommentReactionsEngagedUsersListHelper;
...
public class CommentReactionsEngagedUsersListTool extends AbstractAzureDevOpsTool {
    ...
    private final WitCommentReactionsEngagedUsersListHelper helper;

    @Autowired
    public CommentReactionsEngagedUsersListTool(AzureDevOpsClientService service) {
        super(service);
        this.helper = new WitCommentReactionsEngagedUsersListHelper(service);
    }
    ...
    protected Map<String, Object> executeInternal(Map<String, Object> arguments) {
        ...
        Map<String,Object> resp = helper.fetchEngagedUsers(project, team, wi, ci, API_VERSION_OVERRIDE);
        return success(helper.formatEngagedUsersResponse(resp));
    }
}
