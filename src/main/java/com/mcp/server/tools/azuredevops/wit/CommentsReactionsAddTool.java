...
import com.mcp.server.services.helpers.WitCommentsReactionsAddHelper;
...
public class CommentsReactionsAddTool extends AbstractAzureDevOpsTool {
    ...
    private final WitCommentsReactionsAddHelper helper;

    @Autowired
    public CommentsReactionsAddTool(AzureDevOpsClientService service) {
        super(service);
        this.helper = new WitCommentsReactionsAddHelper(service);
    }
    ...
    protected Map<String, Object> executeInternal(Map<String, Object> arguments) {
        ...
        Map<String,Object> resp = helper.addReaction(project, team, wi, ci, type, API_VERSION_OVERRIDE);
        return success(helper.formatAddResponse(resp, type));
    }
}
