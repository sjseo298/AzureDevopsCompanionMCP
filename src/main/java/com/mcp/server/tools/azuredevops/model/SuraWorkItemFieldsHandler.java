...
/**
 * Manejador de campos obligatorios específicos de YOUR_ORGANIZATION para work items.
 * 
 * @author MCP Server Team
 * @version 1.0.0
 * @since 1.0.0
 */
public class YOUR_ORGANIZATIONWorkItemFieldsHandler {
    ...
    // Valores por defecto para campos específicos basados en los valores exactos de YOUR_ORGANIZATION
    ...
    // Valores válidos para las listas desplegables de YOUR_ORGANIZATION
