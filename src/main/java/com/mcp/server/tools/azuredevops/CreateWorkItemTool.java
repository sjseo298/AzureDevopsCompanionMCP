...
public class CreateWorkItemTool implements McpTool {
    ...
    public Map<String, Object> execute(Map<String, Object> arguments) {
        try {
            ...
            // Validar jerarquía de work items según reglas de Sura
    ...
    /**
     * Valida la jerarquía correcta de work items según las reglas de Sura.
     */
    private void validateWorkItemHierarchy(String type, Number parentIdNum) {
        ...
        try {
            ...
            // Validar jerarquía según reglas de Sura
