...
import com.mcp.server.tools.azuredevops.model.SuraWorkItemFieldsHandler;
...
public class CreateWorkItemTool implements McpTool {
    ...
    public Map<String, Object> execute(Map<String, Object> arguments) {
        try {
            ...
            // Extraer campos específicos de Sura
            ...
            // Usar el manejador de campos obligatorios de Sura
            operations = SuraWorkItemFieldsHandler.addMissingRequiredFields(type, operations, userProvidedValues);
            
            // Validar que todos los campos obligatorios estén presentes
            SuraWorkItemFieldsHandler.ValidationResult validation = 
                SuraWorkItemFieldsHandler.validateRequiredFields(type, operations);
            ...
            if (!validation.isValid()) {
                ...
                Map<String, String> fieldDescriptions = SuraWorkItemFieldsHandler.getRequiredFieldsWithDescriptions(type);
            ...
            Set<String> requiredFields = SuraWorkItemFieldsHandler.getRequiredFields(type);
            if (requiredFields.size() > 4) { // Más que los básicos
                result.append(String.format("%n📋 Campos obligatorios de Sura aplicados para '%s'%n", type));
            }
