 ...
 * incluyendo contexto específico para la estructura organizacional de YOUR_ORGANIZATION Colombia.
 * 
 ...
 *   <li>Contexto específico de YOUR_ORGANIZATION (jerarquía, dominios, nomenclatura)</li>
...
public class HelpTool implements McpTool {
    ...
    private static final String DESCRIPTION = "Obtiene información completa de ayuda sobre el servidor MCP Azure DevOps, incluyendo contexto específico para YOUR_ORGANIZATION Colombia";
    ...
    public Map<String, Object> execute(Map<String, Object> arguments) {
        ...
        if (section == null) {
            ...
            helpText.append(getOverview()).append("\n\n")
                   ...
                   .append(getYOUR_ORGANIZATIONContext()).append("\n\n")
            ...
            switch (section) {
                ...
                case "tools":
                    ...
                    break;
                case "sura_context":
                    helpText.append(getYOUR_ORGANIZATIONContext());
                    break;
                case "examples":
...
Optimizado específicamente para la estructura organizacional y metodología de YOUR_ORGANIZATION Colombia.
...
- 🎯 **Contexto YOUR_ORGANIZATION**: Configuración especializada para el entorno de YOUR_ORGANIZATION Colombia
...
- **create_workitem**: Crea nuevos work items con JSON Patch API
  ...
  - Campos: Todos los campos estándar y personalizados de YOUR_ORGANIZATION
  - Relaciones: Soporte completo para jerarquías padre-hijo
  - Validación: Campos obligatorios por tipo según configuración YOUR_ORGANIZATION
...
- **get_help**: Muestra información de ayuda completa (esta herramienta)
  ...
  - Contexto: Documentación específica para YOUR_ORGANIZATION Colombia

## 📊 Características Especiales
- **JSON Patch Support**: Todas las operaciones de creación/actualización usan RFC 6902
- **YOUR_ORGANIZATION Custom Fields**: Soporte completo para campos personalizados de YOUR_ORGANIZATION
...
- **Safe Deletion**: Eliminación con papelera de reciclaje y confirmación para eliminación permanente""";
    ...
    private String getYOUR_ORGANIZATIONContext() {
        return """
# 🏢 Contexto Específico para YOUR_ORGANIZATION Colombia

## 🔧 Tipos de Work Items Personalizados (OBLIGATORIO USAR EN ESPAÑOL)

### ✅ Tipos Habilitados en YOUR_ORGANIZATION:
...
## 🏢 Jerarquía de Proyectos en YOUR_ORGANIZATION (ACTUALIZADA 2025)
...
1. **Lista todos los proyectos disponibles**:
   ...
   ```
   - Muestra los 3 proyectos principales de YOUR_ORGANIZATION
...
### Campos Específicos YOUR_ORGANIZATION:
...
## 📝 Creación de Work Items (Formato YOUR_ORGANIZATION)
...
## 🏗️ Estructura Organizacional YOUR_ORGANIZATION
...
- **Campos YOUR_ORGANIZATION**: Incluir campos personalizados (ID APM, migración datos, etc.)
- **Control de concurrencia**: Usar revision para updates seguros

## 🏢 Trabajando con Proyectos YOUR_ORGANIZATION
