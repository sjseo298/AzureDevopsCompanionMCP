...
# Script para obtener valores de picklists importantes de YOUR_ORGANIZATION
...
echo "🎯 Obteniendo valores de picklists importantes de YOUR_ORGANIZATION..."
echo "========================================================"
...
get_picklist_values() {
    ...
    local url1="https://dev.azure.com/YOUR_ORGANIZATION/_apis/work/processes/lists/$picklist_id?api-version=7.1"
    ...
    local url2="https://dev.azure.com/YOUR_ORGANIZATION/Gerencia_Tecnologia/_apis/work/processes/lists/$picklist_id?api-version=7.1"
    ...
    local url3="https://dev.azure.com/YOUR_ORGANIZATION/Gerencia_Tecnologia/_apis/wit/fields/$field_ref/allowedValues?api-version=7.1"
