...
### Para YOUR_ORGANIZATION Colombia
```yaml
wiqlContextConfiguration:
  ...
  organizationSpecificFields:
    features:
      - "Microsoft.VSTS.Scheduling.TargetDate"  # Crítico para YOUR_ORGANIZATION
    historias:
...
**Problema:** Código hardcodeado para YOUR_ORGANIZATION
...
- `config/discovered-organization.yml` - Configuración de YOUR_ORGANIZATION
